...
def temp_chatbot_db(tmp_path, monkeypatch):
    ...
    # Mock nts_business_status_client - inject into sys.modules since module doesn't exist locally
    import sys as _sys
    import types as _types
    mock_nts = _types.ModuleType("nts_business_status_client")
    ...
    _sys.modules["nts_business_status_client"] = mock_nts
...
def test_phase3_ttl_cache_logic(client, temp_chatbot_db, monkeypatch):
    ...
    import sys as _sys
    _sys.modules["nts_business_status_client"].check_business_status = mock_check_business_status
...
def test_phase3_batch_dry_run(temp_chatbot_db, monkeypatch):
    ...
    pytest.importorskip("refresh_business_status_baseline", reason="Phase 3 batch modules not available")
    pytest.importorskip("refresh_business_status_incremental", reason="Phase 3 batch modules not available")
    import sqlite3
