...
<span style="font-size:0.6rem; color:#6576ff; font-weight:600; line-height:1.6;">📋 국가계약법 및 지방계약법 적용을 받는 국가·지자체·공공기관·대학 등<br>부산지역 조달청 등록 수요기관의 전체 계약 데이터를 활용하여 수주액·수주율 산출</span>
</div>''', unsafe_allow_html=True)
