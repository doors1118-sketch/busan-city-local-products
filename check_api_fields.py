...
apis = {
    '용역(중앙)': 'https://apis.data.go.kr/1230000/ao/CntrctInfoService/getCntrctInfoListServcPPSSrch',
    '용역(자체)': 'https://apis.data.go.kr/1230000/ao/CntrctInfoService/getCntrctInfoListServcSrch',
}
